...
namespace Inventory {
    ...
    public class GenericTooltip : MonoBehaviour, IPointerExitHandler, IPointerEnterHandler {
        ...
        public bool m_deactivateOnPointerExit = true;
        ...
        [Tooltip ("Deactivates the tooltip when the object this is on is disabled")]
        public bool m_deactivateSelfOnDeactivation = true;
        Vector3 min, max;
        ...
        public void ResetTooltip (string name = "ToolTip", bool destroySpawned = false) {
            if (destroySpawned) {
                if (spawnedTooltip != null) {
        ...
        void OnDisable () {
            if (m_deactivateSelfOnDeactivation) {
                Deactivate ();
            }
        }
    }
